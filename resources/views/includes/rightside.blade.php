<div class="col-md-2 col-xs-12">
    <div class="container">
        <div class="mt-5" style=""> 
            ...
            <a href="{{ URL::to('info/origins/') }}" class="text-right">
                <h6 class="text-left">El comienzo <!--<small>Job Title</small>--></h6>
            </a>
            <a href="{{ URL::to('info/archievements/') }}" class="text-right">
                <h6 class="text-left">Nuestros logros <!--<small>Job Title</small>--></h6>
            </a>
            <a href="{{ URL::to('info/contact/') }}" class="text-right">
                <h6 class="text-left">Contacto <!--<small>Job Title</small>--></h6>
            </a>
            <a href="{{ URL::to('info/about/') }}" class="text-right">
